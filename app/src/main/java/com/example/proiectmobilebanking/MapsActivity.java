...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void draw(){
        ...
        list.add(new Coordonate(51.1605,71.4704,"Астана"));
        list.add(new Coordonate(43.2220,76.8515,"Алматы"));
        list.add(new Coordonate(42.3417,69.5901,"Шымкент"));
        list.add(new Coordonate(43.6588,51.1975,"Актау"));
